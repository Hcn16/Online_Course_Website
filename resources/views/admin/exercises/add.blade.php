                ...
                <div class="col-md-6">
                    <form action="{{route('exercises.store' )}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('name_exercise')}}" class="form-control "
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-md-5">
                                ...
                                <input type="number" value="0" class="form-control sum_question" name="sum_question"
                            ...
                            <div class=" row">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" value="0" class="form-control sum_easy" name="sum_easy"
                                        placeholder="  ">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" value="0" class="form-control sum_medium"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" value="0" class="form-control sum_hard"
