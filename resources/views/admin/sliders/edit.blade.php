                    ...
                    <form action="{{route('sliders.update', ['id'=>$slider->id])}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group @error('description') is-invalid @enderror">
                            ...
                            <input type="text"  class="form-control @error('description') is-invalid @enderror" name="description"
                                ...
                                value="{{$slider->description}} {{old('description')}}  ">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" multiple class="form-control @error('file_path') is-invalid @enderror" name="file_path" id="file_path"
                                placeholder=""
                                value="{{$slider->file_path}}">
                                <a style="width=80px; height=100px" href="{{$slider->image_path}}" > {{$slider->image_name}}</a>
                            <br>
