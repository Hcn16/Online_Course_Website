                        ...
                        <form action="{{route('login')}}" method="post">
                            ...
                            <div style="display:flex;">
                                ...
                                <div  class="form-check mb-3" style="margin-left: 75px;">
                                    <a href="{{route('reset_pass')}}" class="form-check-label" for="rememberPasswordCheck" style="text-decoration: none;" >
                                        Forget password
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="" style="text-align: center; margin-top: 15px; display: flex;">
                                <label for="">Chưa có tài khoản? </label>
                                <a href="{{route('register')}}" class="form-check-label" for="rememberPasswordCheck"
