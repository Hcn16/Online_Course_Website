...
<div class="Message">
    ...
    $('#linkSelect').on('change', function() {
        ...
        <div class="box_parent" id="box-parent">
            ...
            <a class="media" href="{{route('users.detail_chat_for_user', ['id'=>$userItem[0]->id])}}" value="{{$userItem[0]->id}}">
            ...
            <a class="media" href="{{route('users.detail_chat_for_user', ['id'=>$item_noti->id_other_user])}}" value="{{$item_noti->id_other_user}}">
                ...
                <form action="">
                    ...
                    alt="User Avatar" class="img-size-50 img-circle mr-3">
                        <h3 class="dropdown-item-title" >
                            {{$user->get_user_send($item_noti->id_other_user)[0]->name}}
                            </h3>
                        </div>
    ...
    <div class="chat-container">
        ...
        <div class="chat-input">
            ...
            <form class="chat_user"  id="submit_chat"action="" style="display: flex;width: 100%;">
                @csrf
                ...
                <button type="submit" data-url="{{route('courses.send_message_user',
                    ['id_receive'=>$id])}}" class="" id="send_message_1">Send</button>
            </form>
