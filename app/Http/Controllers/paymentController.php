...
class paymentController extends Controller
{
    public function vnpay_payment()
    {
        ...
        $vnp_TmnCode = "VRDHNR0Z";//Mã website tại VNPAY 
        $vnp_HashSecret = "2SOCN0302FVHXIVYFDYBAPEFDFG5HLQZ"; //Chuỗi bí mật
        ...
        //////----------------
        $vnp_TxnRef = "100 000"; //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
    ...
    public function pay(Request $request)
    {
       ...
       $id_course = $request->id_course;
        return view('vnpay_php.vnpay_pay', compact('cost', 'id_course'));
    }
